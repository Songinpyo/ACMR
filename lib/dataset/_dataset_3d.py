...
class Dataset3D(Dataset):
    ...
    def get_single_item(self, index):
        ...
        if self.dataset_name == '3dpw':
            ...
            if is_train:
                top1_action_label = self.db['top1_action_label'][start_index]
                top2_action_label = self.db['top2_action_label'][start_index]
                top3_action_label = self.db['top3_action_label'][start_index]
        ...
        repeat_num = 3
        if self.dataset_name == '3dpw' and is_train:
            target = {
                'features': input,
                ...
                'top1_action_label':top1_action_label,
                'top2_action_label': top2_action_label,
                'top3_action_label': top3_action_label
            }
        else:
            target = {
                'features': input,
        ...
        if self.dataset_name == 'h36m' and not is_train:
            ...
            target['bbox'] = bbox[self.mid_frame]
            target['imgname'] = self.get_sequence(start_index, end_index, self.db['img_name']).tolist()
        elif self.dataset_name == 'h36m' and is_train:
            vn = self.get_sequence(start_index, end_index, self.db['vid_name'])
            fi = self.get_sequence(start_index, end_index, self.db['frame_id'])
        ...
        if self.dataset_name == '3dpw' and not is_train:
            ...
            target['bbox'] = bbox[self.mid_frame]
            target['imgname'] = self.get_sequence(start_index, end_index, self.db['img_name']).tolist()
        elif self.dataset_name == '3dpw' and is_train:
            vn = self.get_sequence(start_index, end_index, self.db['vid_name'])
            fi = self.get_sequence(start_index, end_index, self.db['frame_id'])
            ...
            target['bbox'] = bbox[self.mid_frame]
            target['imgname'] = self.get_sequence(start_index, end_index, self.db['img_name']).tolist()
            target['top1_action_label'] = target['top1_action_label']
