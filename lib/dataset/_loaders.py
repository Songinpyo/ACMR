...
def get_data_loaders(cfg):
    ...
    data_action_3d_batch_size = cfg.TRAIN.BATCH_SIZE

    if cfg.TRAIN.DATA_2D_RATIO != 0.:
    ...
    # ===== Action 3D keypoint datasets =====
    action_train_3d_dataset_names = cfg.TRAIN.ACTION_DATASETS_3D
    action_train_3d_db = get_3d_datasets(action_train_3d_dataset_names)

    action_train_3d_loader = DataLoader(
        dataset=action_train_3d_db,
        batch_size=data_action_3d_batch_size,
        shuffle=True,
        num_workers=cfg.NUM_WORKERS,
    )
    ...
    return train_2d_loader, train_3d_loader, valid_loader, action_train_3d_loader
