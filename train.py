...
from lib.core.loss import TCMRLoss, Action_TCMRLoss
from lib.core.trainer import Trainer
from lib.core.config import parse_args, BASE_DATA_DIR
from lib.utils.utils import prepare_output_dir
from lib.models import Action_TCMR, TCMR, MotionDiscriminator
...
def main(cfg):
    ...
    generator = Action_TCMR(
        n_layers=cfg.MODEL.TGRU.NUM_LAYERS,
        batch_size=cfg.TRAIN.BATCH_SIZE,
        seqlen=cfg.DATASET.SEQLEN, # 16
